...
void drawGround()
{
    ...
    drawRect(-1.0f, -1.0f, 1.0f, -0.20f);

    glColor3f(1.0f, 1.0f, 1.0f);
    for (int i = 0; i < 10; i++) {
        float lx = -0.95f + i * 0.28f;
...
void drawBuilding()
{
    ...
    if (doorOpen)
        ...
        doorW = 0.14f;
    drawRect(doorX, -0.20f, doorX + doorW, 0.08f);

    glColor3f(0.80f, 0.65f, 0.10f);
    drawCircle(doorX + doorW - 0.02f, -0.06f, 0.012f);

    if (isDaytime) glColor3f(0.88f, 0.82f, 0.68f);
    else           glColor3f(0.38f, 0.35f, 0.28f);
    drawRect(-0.74f, -0.20f, -0.70f, 0.10f);
    drawRect(-0.58f, -0.20f, -0.54f, 0.10f);

    if (isDaytime) glColor3f(0.82f, 0.76f, 0.62f);
    else           glColor3f(0.35f, 0.32f, 0.26f);
    drawRect(-0.76f, -0.20f, -0.50f, -0.17f);
    drawRect(-0.74f, -0.17f, -0.52f, -0.14f);
}
...
int main(int argc, char** argv)
{
    ...
    glutCreateWindow("Project group number 8");
